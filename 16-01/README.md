...
```
После исправления первых двух выявленных ошибок снова выполнил команду ```terraform validate``` и снова получил сообщение об ошибке.

Честно говоря, я даже сначала не понял, как так, что ранее объявленный ресурс не объявлен в моём коде. Всё же ночные домашние работы снижают бдительность ))).
