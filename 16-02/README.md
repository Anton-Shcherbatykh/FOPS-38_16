...
Инициализвраод проект. Выявил ошибки

![alt text](Pictures/pic03.jpg)

Сразу бросилось в глаза, что написанво ```standart``` вместо правильного ```standard```. Исправил. Попробовал выполнить ```terraform apply``` но снова получил сообщение об ошибке
